...
const getInitialHashedUsers = async () => await Promise.all(initialUsers.map(async (user)=>{
...
module.exports = {
  initialBlogs, initialUsers, nonExistingId, blogsInDB, usersInDB, getInitialHashedUsers, initDatabase
}